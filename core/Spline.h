...
//#define M_PI 3.1415926535897932
        ...
        public:
            ...
            enum bd_type {
                first_deriv = 1,//ָ�������˵��һ�׵���Ϊĳ���̶�ֵ
                second_deriv = 2,//�����˵�Ķ��׵���Ϊ0�� Natural Spline��
                not_a_knot = 3//��һ����ֵ������׵���ֵ���ڵڶ���������׵���ֵ������һ��������׵���ֵ���ڵ����ڶ���������׵���ֵ�������X����Ҫ����=4��
            };
        ...
        public:
            ...
            // at both ends, i.e. natural splines,Ĭ����Natural Spline
            ...
            // adjust coefficients so that the spline becomes piecewise(�ֶ�) monotonic(�������ޱ仯��)
            // where possible
            //   this is done by adjusting slopes(б��) at grid points by a non-negative
